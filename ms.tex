...
% Kelly cut: In addition to the M$-\sigma$, other relations between th,e SMBH and its host have been well studied, making it clear that, though these objects have many orders of magnitude between their sizes, a complex interplay still exists.
...
%Black holes are not fixed within the center of their host, allowing them to be dynamically affected by mergers and other perturbations within the galaxy. Nevertheless, BHs remain near their host centers by choosing dark matter particle masses in high-resolution regions to be on the same order as gas particle masses, minimizing two-body interactions \citep{Bellovary2011}.
...
%\textcolor{violet}{
%To better understand the apparent preference for merger-accreted gas, we examine the angular momentum of each type of gas at the moment it enters the galaxy. Figure \ref{hrh258angmom} shows that gas entering the SMBH (dashed lines) has an overall lower angular momentum than gas entering galaxy (solid lines), as expected. This statement is true regardless of the gas state, where green, blue, and red indicate clumpy, unshocked, and shocked gas, respectively. 
%}

%\textcolor{violet}{
%Figure \ref{hrh258angmom_merger1} explicitly shows that during the z~1.8 merger, the lowest angular momentum gas entering the galaxy (solid lines) is merger-driven (green, solid line). This is reflected in the SMBH (green, dashed line) as nearly all the clumpy gas at this time funnels directly into the SMBH. 
%}
...
%This may imply that the low angular momentum of the gas accreted onto the SMBH may have some of its angular momentum due to the physical properties of the merger \citep{Capelo2015}.

%}

%\textcolor{violet}{
%We can also examine another similar cumulative distribution which includes specifically angular momentum of the gas that is associated with secondary halo (the second most massive halo in the zoom-in simulation). Figure \ref{hrh258angmom_mergergas} has the same angular momentum information for the main halo (solid lines), but the green dashed line now indicates the angular momentum gas \textit{only} associated with the merging secondary halo. We note that a large portion of this gas enters with a higher angular momentum than the cumulative average, yet not nearly as high as the angular momentum of cumulative unshocked and shocked gas.  Jillian cut 9/13/16
%}
...
%\caption[]{Face-on Sunrise images of our ChaNGa galaxy, h258, which has
%an active, merger-rich history. NEED TO REPLACE, this is low res h258}
%\label{h258face} 
%\end{figure}

%\centerline{\resizebox{0.75\hsize}{!}{\includegraphics[angle=0]{angmom_cumudist_cumu_plusmerger_4096_only1296_andclumpy}}}
%\caption[]{ Cumulative distribution of angular momentum of the gas particles accreted onto the h258 galaxy at the time of the primary major merger (z $\sim$ 1.2). The solid lines indicate the angular momentum of gas accreted onto the main halo (similar to Figure \ref{hrh258angmom}) and the dashed line indicates the angular momentum of gas entering from the secondary halo. As before, green, blue, and red lines indicate clumpy, unshocked, and shocked gas, respectively.}
%\label{hrh258angmom_mergergas} 
%\end{figure}

%\begin{figure}
%\centerline{\resizebox{0.75\hsize}{!}{\includegraphics[angle=0]{hrh258_am_tsnew_1128}}}
%\caption[]{ Cumulative distribution of angular momentum of the gas particles accreted onto the h258 galaxy at the time of the less massive merger (z $\sim$ 1.8). There are about 900,000 gas particles accreted at this timestep, which gas particles accreted onto the main halo and central black hole are distinguished by solid and dashed lines. The green, blue, and red lines indicate clumpy, unshocked, and shocked gas, respectively.}
%\label{hrh258angmom_merger1} 
%\end{figure}

\bibliography{/Users/the_neekster/Documents/REPOSITORIES/Papers/aparticularappetite2016/Sanchez2016.bib}
